        ...
        <div class="2xl:w-[35%] w-1/2 container mx-auto">
            ...
            <p class="text-[#000000] font-[600] pb-6 text-center">Your code was sent to you via email</p>
             <div class="px-[5rem]">
                ...
                <div class="pb-2">
                    <router-link :to="{name: 'Authentication'}" class="hover-btn text-center  w-full p-3 rounded-xl text-white bg-gradient-to-b from-[#b72b33] bg-[#962d34] font-[700] text-xl uppercase">Verify Your Code</router-link>
                </div>
