    ...
    <section class="overflow-y-auto max-h-[70vh] pb-[3rem] px-6">
      <div class="border-b-[1px] pb-8 border-[#707070]">
        <div class="flex justify-between">
          <div class="w-full">
            <h1 class="font-[700] text-2xl">Rapid Acceleration</h1>
          
            <p class="py-3">
                Receive an alert when your vehicle rapidly accelerates excessively or moderately.
            </p>
          ...
          <div class="w-[20%]">
           <div class="flex justify-end">
            ...
            <div class="flex justify-end pt-14 space-x-3">
                <div>
                    <button
