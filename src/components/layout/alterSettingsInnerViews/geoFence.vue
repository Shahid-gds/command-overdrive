<template>
    <section class="screen-height overflow-y-auto max-h-[70vh] px-6">
      <div
        class="border-b-[1px] pb-8 border-[#707070]">
          <div class="flex justify-between">
            <div class="w-full">
              <h1 class="font-[700] text-2xl pb-3">Geo-Fencing</h1>
              <div>
            <div class="2xl:flex items-center">
                <div class="2xl:w-[25%] 2xl:pb-0 pb-4">
                    <button class="border-2 border-[#636363] rounded-lg p-2 px-6">Create Geo-Fencing </button>
                 </div>
                <div class="w-full">
                    Think of a Geo-Zone as geo-matric zone surrounding a location, like a target. You can set up Geo-Zones to send you an alert when a vehicle goes inside and/or outside the zone.
                 </div>
            </div>
              </div>
            </div>
      ...
      <div
        class="border-b-[1px] py-8 border-[#707070]">
            <div class="2xl:flex 2xl:space-x-10">
                <div class="2xl:w-[40%] 2xl:pb-0 pb-8">
                    <div class="font-[700] uppercase pb-2">Geo-Zone</div>
                    <div>
                        <input type="text" class="w-full border-[1px] border-[#636363] p-2 rounded-lg outline-none placeholder:text-[#979797] placeholder:uppercase" placeholder="Name">
                    </div>
                    <div class="flex justify-between items-center pt-5">
                        <div class="text-[#3B3B3B] font-[600]">Alert when Entering <span class="text-[#979797]">Geo-Zone</span></div>
                        <div class="button b2" id="button-13">
                            <input type="checkbox" class="checkbox" />
                            <div class="knobs">
                              <span></span>
                    ...
                    <div class="flex justify-between items-center pt-5 border-b-[1px] pb-4 border-[#707070]">
                        <div class="text-[#3B3B3B] font-[600]">Alert when Exiting <span class="text-[#979797]">Geo-Zone</span></div>
                        <div class="button b2" id="button-13">
                            <input type="checkbox" class="checkbox" />
                            <div class="knobs">
                              <span></span>
                    ...
                    <div class="pt-4">
                      <h1 class="font-[700] text-[20px]">Schedule</h1>
                      <p class="font-[500]">You can set up when you want this Geo-Zone to be active. Leave the fields blank if you do not want the Geo-Zone to be active.</p>
                      <div class="pt-4">
                      ...
                      <div class="pt-6">
                        <h1 class="font-[700] text-[16px] uppercase">Auto-Tag</h1>
                        <p class="py-2">Auto-tag trips that enter the set location</p>
                        <div>
                          <button class="p-3 border-[1px] border-[#D63D4A] rounded-lg px-6 text-[#D63D4A] font-[600]">SELECT TAG</button>
                        </div>
                      </div>
      ...
      <div class="py-12 border-b-[1px] border-[#707070]">
        <h1 class="font-[700] text-2xl pb-3">Geo-Fences Applied</h1>
            ...
            <table class="w-full">
              <thead class="border-gray-300">
                <tr class="text-xs text-left">
                  ...
                  <th class="border-r-2 border-b-2 p-2">Geotag</th>
                  <th class="border-r-2 border-b-2 p-2 2xl:w-1/2 w-[35%]">Description </th>
                  <th class=" border-b-2 p-2">Vehicle Applied</th>                
                </tr>
              </thead>
              <tbody>
                <tr
                  ...
                  <td class="border-r-2 border-b-2 p-2">{{ item.Geotag }}</td>
                  ...
                  <td class="border-b-2 p-2">
                    <div class="flex justify-between items-center">
                      ...
                      <div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="#9A9A9A" class="size-8">
  ...
  import alterMap from "@/views/Alters/alterMap.vue";
