    ...
    <section class="overflow-y-auto max-h-[70vh] pb-[3rem] px-6">
      <div class="border-b-[1px] pb-8 border-[#707070]">
        <div class="flex justify-between">
          <div class="w-full">
            <h1 class="font-[700] text-2xl">Battery</h1>
          
            <p class="py-3">
                Enable this notification to be alerted when your battery voltage dips below a certain number. Select Low & Critical to be notified when the voltage is below 12 volts. Select Critical Only to be notified when the voltage is below 11.5 volts.
            </p>
           ...
           <div>
              <button
              class="border-[2px] bg-[#2D2D2D] text-white border-[#2D2D2D] p-2 px-6 rounded-lg font-[600] uppercase">
              Critical Only
            </button>
           </div>
            </div>
            ...
            <div class="pt-14">
              <div class="flex justify-end space-x-3">
                <div>
                  ...
                  <p class="text-xs pt-2 font-[500] text-[#D63D4A] text-right">Learn more about Battery alerts</p>
              </div>
          </div>
        </div>
      </div>
