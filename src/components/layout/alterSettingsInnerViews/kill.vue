      ...
      <div
        class="border-b-[1px] pb-8 border-[#707070]">
          <div class="flex justify-between">
            <div class="w-full">
              <h1 class="font-[700] text-2xl pb-3">Engine Enabled or Disabled</h1>
              <p>
          ...
          <div class="pt-3 flex space-x-4">
            <div>
                <button class="border-[1.5px] border-[#636363] p-2 px-6 rounded-lg uppercase text-[#636363]">Enabled</button>
            </div>
            <div>
                <button class="bg-[#636363] border-[1.5px] border-[#636363] p-2 px-6 rounded-lg uppercase text-[white]">Disabled</button>
            </div>
        </div>
      </div>
