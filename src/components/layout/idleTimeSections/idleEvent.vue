        ...
        <div class="border-b-[1px] pb-16 border-[#707070]">
            <div class="w-full">
                <div class="flex justify-between">
                    <div class="w-full">
                      <h1 class="font-[700] text-2xl">Idle Event</h1>
                      <p class="pb-6">Receive an alert each time your car has idled past the time you set.</p>
                      <div class="slider-container py-[3rem] w-full">
                        <div class="slider-track" ref="track">
                          ...
                          <div
                            ...
                            <span class="flag w-[50px] text-center border-2 bottom-[30px] -right-[16px] z-20  p-2 rounded-lg text-[#757575] font-[700]">{{ min }}</span>
                          </div>
                        </div>
                      </div>
                    </div>
